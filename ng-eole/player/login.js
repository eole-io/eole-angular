...
ngEole.config(['$routeProvider', function ($routeProvider) {
    $routeProvider.when('/player/login', {
        ...
        templateUrl: 'ng-eole/player/login.html'
    });
}]);

ngEole.controller('LoginController', ['$scope', '$location', 'eoleSession', '$timeout', function ($scope, $location, eoleSession, $timeout) {
